...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 20 }
end
...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 16 }
end
...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 14 }
end
...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 12 }
end
...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 10 }
end
...
t += time_elapsed do
  ...
  Uci::Engine.new.analyze fen, { :depth => 16, :multipv => 3 }
end
